...
public class LoginController : Controller
{
    ...
    public LoginController(IUsuarioRepository userRepository, ILogger<LoginController> logger, HttpContext context)
    {
        _logger = logger;
    ...
    public IActionResult Index()
    {
        try
        {
            ...
            log.IsAuthenticated = _context.Session.GetString("IsAuthenticated") == "true";
